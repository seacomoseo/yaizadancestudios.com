...
- [Github new acount](https://github.com/join)
  - User name: `yaizadancestudios`
  - Email: `yaizadancestudios@seacomoseo.com`
  - Password: `var_pass`
  - Verify and exit
- [New repository](https://github.com/new)
  - `Repository name` = `yaizadancestudios.com`
  - `Private` = check
  - `Create repository`
- [Settings](https://github.com/yaizadancestudios/yaizadancestudios.com/settings) ⏩ check `Include Git LFS objects in archives`
...
- [Gitlab new acount](https://gitlab.com/users/sign_up)
  ...
  - Email: `yaizadancestudios@seacomoseo.com`
  - Password: `var_pass`
  - Note in `🔥 SanSoul/yaizadancestudios.com.md`
  - Verify
  - Role: `Other`
...
- New or fork project
  ...
  - If [Fork this project](https://gitlab.com/yaizadancestudios/yaizadancestudios.com/-/forks/new)
  - `Project name` and `Project slug` = `yaizadancestudios.com`
  - `Visibility level` = `Private`
  - `Initialize repository with a README` = uncheck
- [Mirror repository](https://gitlab.com/yaizadancestudios/yaizadancestudios.com/-/settings/repository#js-push-remote-settings)
  - `Add new`
  - `Git repository URL` = `https://yaizadancestudios@github.com/yaizadancestudios/yaizadancestudios.com.git`
  - `Password` = prev token from Github (`ghp_**********`)
  - `Mirror repository`
- [Members](https://gitlab.com/yaizadancestudios/yaizadancestudios.com/-/project_members) ⏩ Add your email with role `Maintainer`
- Icons
  - [General Settings](https://gitlab.com/yaizadancestudios/yaizadancestudios.com/edit) ⏩ `Project avatar`
...
- [Repository](https://gitlab.com/yaizadancestudios/yaizadancestudios.com) ⏩ `Clone ⏩ Visual Studio Code (HTTPS)` ⏩ select sansoul folder (not new folder)
...
- `Skip personalization ⏩ New site from Git ⏩ Gitlab ⏩ Authorize ⏩ Select repo ⏩ Deploy site ⏩ Site settings`
  - `Change site name ⏩ yaizadancestudios` and copy in `data/config.yml ⏩ netlify_name`
  - Copy `API ID` in `data/config.yml ⏩ netlify_id`
  - [Build hooks](https://app.netlify.com/sites/yaizadancestudios/settings/deploys#build-hooks) with = `build` name ⏩ copy and paste in `yaizadancestudios.com/yaizadancestudios.com.md` and [spreadsheet projects](https://docs.google.com/spreadsheets/d/1QIeT5VfUuXC3momIScZPf8ZPahV23tXVNshcf6DRipA/).
...
- [Cloudflare Pages new project with Gitlab](https://dash.cloudflare.com/?to=/:account/pages/new/provider/gitlab)
  ...
  - `Project name` = `yaizadancestudios` and copy in `data/config.yml ⏩ cloudflare_project_name`
...
- If Identity Access
  - [`Netlify ⏩ Site ⏩ Settings ⏩ Identity`](https://app.netlify.com/sites/yaizadancestudios/settings/identity) ⏩ `Enable Identity`
    - [`Git Gateway`](https://app.netlify.com/sites/yaizadancestudios/settings/identity#git-gateway) ⏩ `Edit settings` ⏩ Paste the gitlab code copied in `GitLab personal access token ⏩ Save`
    - [Registration preferences](https://app.netlify.com/sites/yaizadancestudios/settings/identity#registration-preferences) ⏩ Edit settings ⏩ Invite only ⏩ Save
    - [`External providers`](https://app.netlify.com/sites/yaizadancestudios/settings/identity#external-providers) ⏩ Add provider ⏩ Gitlab ⏩ Use default configuration ⏩ Enable GitLab
  - [`Netlify ⏩ Site ⏩ Identity`](https://app.netlify.com/sites/yaizadancestudios/identity) ⏩ Invite users ⏩ email `yaizadancestudios@seacomoseo.com` (and other if you want) ⏩ Check email from `no-reply@netlify.com` ⏩ Accept the invite ⏩ Add `/admin/` in the URL between `/` and `#` ⏩ Add password `var_pass`
...
- If new project (not fork):
  - Copy [yaizadancestudios.com project files](https://gitlab.com/yaizadancestudios/yaizadancestudios.com)
...
- `README.md` ⏩ edit baseURL ("yaizadancestudios.com") + delete steps bit by bit
- Design
...
- If Netlify
  - [`Domain Management / settings`](https://app.netlify.com/sites/yaizadancestudios/settings/domain)
  - `Add custom domain`
  - `Check DNS configuration` Copy
  - Add `DNS Records` copied from Netlify to Domain gestor:
    - From: `yaizadancestudios.com`
    ...
    - From: `www`
      DNS Record: `CNAME`
      To: `yaizadancestudios.netlify.app.`
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/yaizadancestudios/domains)
  - `Set up a custom domains`
  - `yaizadancestudios.com`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.yaizadancestudios.com`
  - ...........................................................
...
1. [Servicios yaizadancestudios.com](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
